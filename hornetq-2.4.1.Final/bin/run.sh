...
if [ ! -d $CONFIG_DIR ]; then
    echo HORNETQ_HOME is undefined >&2
    exit 1
fi
...
echo "***********************************************************************************"
java $JVM_ARGS -classpath $CLASSPATH -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=3000 -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false org.hornetq.integration.bootstrap.HornetQBootstrapServer $FILENAME
